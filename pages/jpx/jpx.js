...
Page({
  ...
  submit: function(e) {
    ...
    if (!e.detail.value.score0 || !e.detail.value.score1 || !e.detail.value.score2 || !e.detail.value.score3 || !e.detail.value.score4 || !e.detail.value.score5 || !e.detail.value.score6 || !e.detail.value.score7 || !e.detail.value.score8 || !e.detail.value.score9) {
      ...
      wx.navigateTo({
        url: '/pages/student/student?score0=' + e.detail.value.score0 + '&score1=' + e.detail.value.score1 + '&score2=' + e.detail.value.score2 + '&score3=' + e.detail.value.score3 + '&score4=' + e.detail.value.score4 + '&score5=' + e.detail.value.score5 + '&score6=' + e.detail.value.score6 + '&score7=' + e.detail.value.score7 + '&score8=' + e.detail.value.score8 + '&score9=' + e.detail.value.score9 +'&classname='+that.data.class_name,
      })
    }
  },
